...
\begin{enumerate}
	\item  Introduce intermediate variables for subexpressions, for both binary and unary operators; e.g., $\times$ is binary, $sin(x)$ and other trigonometric functions are usually unary because there is a single operand.
